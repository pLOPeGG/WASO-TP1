    ...
    protected void service(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if ("getListeClient".equals(som)) {
                ...
                String denominationClient = request.getParameter("denomination");
                ...
                if(denominationClient == null){
                    throw new ServiceException("Paramètres incomplets");
                }
               
                
                service.rechercherClientParDenomination(denominationClient, villeClient);
